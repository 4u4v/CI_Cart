  ...
  <div class="right">
    ...
    <div class="right_box1_left">
	  ...
	  <div id="Focus_Img">
		...
		picarr[1]  = "";
	    textarr[1] = "";
		picarr[1]  = "<?php echo base_url()?>images/banner/banner_1.jpg";
		picarr[2]  = "<?php echo base_url()?>images/banner/banner_2.jpg";
		picarr[3]  = "<?php echo base_url()?>images/banner/banner_3.jpg";
	...
	<div class="right_box1_right">
	  <div id="report" class="m">
		...
		<div class="mc">
          <ul>
		  <?php for($i=0;$i<8;$i++){?>
          <li>·<a target="_blank" href="">广西开通8个城市货到付款！</a></li>
		  <?php }?>
          </ul>
