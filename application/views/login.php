  ...
  <div class="mright">
	...
	<div class="lo_corner_c">
	  ...
	  <div class="lo_child" style="width: auto; padding-right: 0pt;">
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;邮&nbsp;&nbsp;箱：<input name="tbxRegisterEmail" maxlength="50" id="tbxRegisterEmail" type="text">
...
<script type="text/javascript" src="http://127.0.0.1/ci_cart/js/jquery_002.js"></script>
<script type="text/javascript" src="http://127.0.0.1/ci_cart/js/jquery-validate.js"></script>
