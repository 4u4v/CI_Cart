...
<div class="Main">
  <div id="Position" class="margin_b6">
	...
	<?php   }?>
    <a href="<?php echo site_url('product/single/product_id/'.$product['id'])?>"><?php echo $product['name']; ?></a>
  </div>
	...
	<div class="Product_Intro">
	  ...
	  <div id="Product_Intro_Right">
	    <ul class="Pro_baseinfo">
		  <li>商品编号：<?php echo $product['short_name']; ?></li>
	      <li>市&nbsp;场&nbsp;价：<em class="m_line">￥<?php echo $product['market_price']; ?></em></li>
	      ...
	      <li id="short_desc"><font color="#ff0000"><?php echo $product['short_desc']; ?></font></li>
