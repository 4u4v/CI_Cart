...
<div id="menu" class="x-panel x-border-panel x-tree " style="width: 225px; position: absolute; visibility: visible; left:5px; z-index:1; height:100% ">
  ...
  <div  class="x-panel-bwrap ">
	...
	<div  class="x-toolbar">
	  ...
	  <tr>
	      <td class="x-btn x-btn-text-icon">
			...
			<em ><button  class="x-btn-text add-feed" type="button" onclick="parent.document.getElementById('main-frame').src='<?php echo site_url('customer/edit');?>'">添加用户</button></em>
			</td>
    ...
    <li class="x-tree-node">
	  ...
	  <li class="x-tree-node"><div  class="x-tree-node-el x-tree-node-leaf feed x-tree-selected " ><span class="x-tree-node-indent"><img class="x-tree-icon" src="<?php echo base_url()?>images/s.gif"/></span><img  class="x-tree-node-icon feed-icon" src="<?php echo base_url()?>images/s.gif"/><a href="<?php echo site_url('customer')?>" target="main-frame"><span >用户列表</span></a></div></li>

	  <li class="x-tree-node"><div  class="x-tree-node-el x-tree-node-leaf feed" ><span class="x-tree-node-indent"><img class="x-tree-icon" src="<?php echo base_url()?>images/s.gif"/></span><img  class="x-tree-node-icon add-feed" src="<?php echo base_url()?>images/s.gif"/><a  href="<?php echo site_url('customer/edit')?>" target="main-frame" ><span >添加用户</span></a></div></li>
