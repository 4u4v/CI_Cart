		...
		<table cellpadding="3" cellspacing="0" id="listTable" >
		  ...
		  <tr class="x-grid3-row "  >
			...
			<td ><div class="x-grid3-cell-inner ">			 
			 ...
			 <a href='#' onclick="return delete_submit('<?php echo $value['id'];?>','<?php echo site_url('customer/delete/id/'.$value['id'])?>',this,'用户',true)" style="text-decoration:none" alt='删除' title='删除'>
