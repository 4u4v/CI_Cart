...
<!-- 
 ...
 -->
    <div class="x-form-item" >
      ...
      <div class="x-form-element"  style="padding-left: 80px;">
        <input style="width: 222px;" class="x-form-text x-form-field x-form-bg-invalid" size="20" id="password" name="password"  type="password" value="" ><br/>
		<!-- <br/>或<br/><br/>自动生成密码 <input type="checkbox" class=" x-form-field " id="password_auto" name="password_auto" value="1" class="x-form-text x-form-field " " <?php if($editing['password_auto'])echo "checked='checked'" ;?> /> -->
      </div>
      <div class="x-form-clear-left"></div>
    </div>
