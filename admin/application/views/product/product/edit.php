...
<div id="main-tabs" class="x-tab-panel x-border-panel" style="left: 5px; top: 0px; ">
	...
	<div id="menu-body" class="x-panel-body x-panel-body-noheader x-panel-body-noborder x-border-layout-ct " style="overflow:auto">
	  ...
	  <div id="basic-div" class="tab-div" style="display:block">
		  ...
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">商品编号:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  ...
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">是否上架:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  ...
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">是否新品:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  ...
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">是否热卖:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
		  ...
		  <div class="x-form-item" >
		  <label  style="width: 75px;color:dimgray;" class="x-form-item-label">是否推荐:</label>
		  <div class="x-form-element"  style="padding-left: 80px;">
