...
{
	if (confirm('确定删除该属性分组吗？')){
   
	window.location.href= '<?php echo site_url('attribute_set/delete/id')?>'+'/'+id;
    }
}
...
<div id="msg"></div>
  ...
  <span class="x-tab-strip-text">属性分组列表</span>
  </span>
  </em>
  </a>
  </li>
  ...
  <!-- 菜单体 -->
  <div  class="x-panel-body x-tab-panel-bwrap border-bottom">
  ...
  <div style="position: relative;" id="ext-gen74" class="x-panel-bwrap">
	  ...
	  <td onClick="window.location.href='<?php echo site_url('attribute_set/add')?>'"><table style="width: hidden;" class="button x-btn-wrap x-btn x-btn-text-icon " border="0" cellpadding="0" cellspacing="0" ><tbody><tr>
		...
		<table cellpadding="3" cellspacing="0" id="listTable" >
		 <thead>
		  <tr class="x-grid3-header">
			...
			<th class="sort-alpha">
			<div class="x-grid3-hd-inner">属性分组名字<img class="x-grid3-sort-icon" src="<?php echo base_url()?>images/s.gif"></div></th>
		    
			<th class="sort-alpha">
			<div class="x-grid3-hd-inner">属性数<img class="x-grid3-sort-icon" src="<?php echo base_url()?>images/s.gif"></div></th>
		 ...
		 <tbody>
		  ...
		  <tr >
            <td class=""><div class="x-grid3-cell-inner ">
			<?php echo $value['id'] ?></div></td>

			<td class=""><div class="x-grid3-cell-inner ">
			<?php echo $value['name'] ?></div></td>

			<td class=""><div class="x-grid3-cell-inner ">
			<?php echo $value['attr_count'] ?></div></td>

			<td ><div class="x-grid3-cell-inner ">
			 <a href='<?php echo site_url('')?>' style="text-decoration:none" alt='浏览' title='浏览'>
			 <img src="<?php echo base_url()?>images/icon_view.gif" border="0" width="16" height="16">
			 </a>&nbsp;&nbsp;
			 <a href='<?php echo site_url('attribute_set/edit/id/'.$value['id'])?>' style="text-decoration:none" alt='编辑' title='编辑'>
